                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/nsd999/Kuhoo/releases/download/${currentStatus.version}/vivi.apk"
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/nsd999/Kuhoo/releases")
            ...
            if (betaEnabled) {
                try {
                    val nightlyUrl = URL("https://api.github.com/repos/nsd999/Kuhoo/actions/workflows/nightly.yml/runs?status=success&per_page=100")
            ...
            if (isNightlyUpdate && nightlyRunObject != null) {
                ...
                val apkDownloadUrl = "https://nightly.link/nsd999/Kuhoo/workflows/nightly.yml/main/vivi-music-gms-nightly.zip"
            ...
            if (targetRelease != null) {
                ...
                if (shouldShow) {
                    ...
                    try {
                        val changelogUrl =
                            URL("https://github.com/nsd999/Kuhoo/releases/download/$tagWithPrefix/changelog.json")
